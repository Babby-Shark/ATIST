...
<html>
  ...
  <body>
      ...
      <div data-layer="Custom Beat Requests" class="CustomBeatRequests" style="width: 624px; left: 80px; top: 2198px; position: absolute; color: black; font-size: 48px; font-family: Inter; font-weight: 600; word-wrap: break-word">
      ...
      <div data-layer="Text" class="Text" style="width: 516px; left: 79px; top: 2304px; position: absolute; flex-direction: column; justify-content: flex-start; align-items: flex-end; gap: 48px; display: inline-flex">
        <div data-layer="Text" class="Text" style="align-self: stretch; flex-direction: column; justify-content: center; align-items: flex-start; gap: 8px; display: flex">
          <div data-layer="Tell Us Your Sound" class="TellUsYourSound" style="width: 515px; color: black; font-size: 24px; font-family: Inter; font-weight: 500; line-height: 36px; word-wrap: break-word">
            Tell Us Your Sound
          </div>
          <div data-layer="Describe the vibe, and share any reference tracks." class="DescribeTheVibeAndShareAnyReferenceTracks" style="width: 515px; justify-content: center; display: flex; flex-direction: column; color: #828282; font-size: 24px; font-family: Inter; font-weight: 400; line-height: 36px; word-wrap: break-word">Describe the vibe, and share any reference tracks.</div>
        </div>
        <div data-layer="Text" class="Text" style="align-self: stretch; flex-direction: column; justify-content: center; align-items: flex-start; gap: 8px; display: flex">
          <div data-layer="Connect with a Producer" class="ConnectWithAProducer" style="width: 515px; color: black; font-size: 24px; font-family: Inter; font-weight: 500; line-height: 36px; word-wrap: break-word">
        ...
        <div data-layer="Text" class="Text" style="align-self: stretch; flex-direction: column; justify-content: center; align-items: flex-start; gap: 8px; display: flex">
          <div data-layer="Get & Refine Your Beat" class="GetRefineYourBeat" style="align-self: stretch; color: black; font-size: 24px; font-family: Inter; font-weight: 500; line-height: 36px; word-wrap: break-word">
            Get & Refine Your Beat
          </div>
          <div data-layer="Receive your custom-made beat in your preferred format. Need tweaks? No problem—request adjustments until it fits just right." class="ReceiveYourCustomMadeBeatInYourPreferredFormatNeedTweaksNoProblemRequestAdjustmentsUntilItFitsJustRight" style="align-self: stretch; justify-content: center; display: flex; flex-direction: column; color: #828282; font-size: 24px; font-family: Inter; font-weight: 400; line-height: 36px; word-wrap: break-word">
      ...
      <div data-layer="Buttons" class="Buttons" style="left: 80px; top: 2832px; position: absolute; justify-content: flex-start; align-items: center; gap: 16px; display: inline-flex">
        <div data-layer="Button" class="Button" style="padding-left: 24px; padding-right: 24px; padding-top: 12px; padding-bottom: 12px; background: black; box-shadow: 0px 1px 2px rgba(0, 0, 0, 0.05); border-radius: 8px; justify-content: flex-start; align-items: center; gap: 8px; display: flex">
      ...
      <div data-layer="Copy" class="Copy" style="width: 844px; left: 79px; top: 212px; position: absolute; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 40px; display: inline-flex">
        <div data-layer="Page title" class="PageTitle" style="align-self: stretch; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 24px; display: flex">
          <div data-layer="Unlock the Sound, Welcome to BeatVault." class="UnlockTheSoundWelcomeToBeatvault" style="align-self: stretch; color: black; font-size: 64px; font-family: Inter; font-weight: 700; word-wrap: break-word">
